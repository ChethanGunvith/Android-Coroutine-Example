package com.chethan.coroutinesample.userdetails
...
import com.chethan.coroutinesample.common.UserPostListAdapter
import com.chethan.coroutinesample.databinding.UserDetailsFragmentBinding
import com.chethan.coroutinesample.repository.UserDetailsRepository
import com.chethan.coroutinesample.utils.InternalDataFromFileImpl
import com.chethan.coroutinesample.utils.autoCleared
...
class UserDetailsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val viewModel = ViewModelProviders
                .of(this,
                    UserDetailsViewModel.FACTORY(repository)
                )
